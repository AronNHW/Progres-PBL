            ...
            <tbody>
                @forelse($aspirasis as $aspirasi)
                    <tr>
                        ...
                        <td>
                            <a class="btn-blue" href="{{ route('pengurus.aspirasi.show', $aspirasi) }}">Lihat</a>
                            <form action="{{ route('pengurus.aspirasi.destroy', $aspirasi) }}" method="POST" style="display:inline" onsubmit="return confirm('Hapus aspirasi ini?')">
                                @csrf
                                @method('DELETE')
